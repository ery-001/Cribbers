...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex justify-between items-center h-24 w-full mx-auto px-4  text-black bg-white  relative' >
        <img className='w-40 lg:mx-12 md:mx-auto sm:mx-auto' src={logo} alt="/" />
      <ul className="hidden md:flex text-bold cursor-pointer">
        <li className="p-4 font-bold hover:border-b-black ease-in-out duration-500 border-2 rounded-5 border-transparent "><a href='/home'>Home</a></li>
      ...
      <img className='w-40 p-4' src={logo} alt="/" />
        ...
        <ul className=' uppercase p-4'>
          ...
          <li className="p-4 border-b border-gray-700 ">About Us</li>
          <li className="p-4 border-b border-gray-700 ">Projects</li>
          <li className="p-4 border-b border-gray-700 ">Events</li>
        </ul>
